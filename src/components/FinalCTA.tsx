...
const lojas = [
  ...
  // },
  {
    ...
    endereco:
      "R. Gen. Landri Gonçalves, 305 - Recreio dos Bandeirantes, Rio de Janeiro - RJ, 22795-410",
    telefone: "(21) 3251-3756",
    whatsapp: "(21) 99403-5132",
    email: "loja2@casadoviana.com",
    horario: "Seg a Sex 8:00–18:00 | Sáb 8:00–13:00",
  },
];
...
const FinalCTA = () => {
  return (
    <section
      id="orcamento"
      className="py-12 md:py-20 bg-hero-gradient relative overflow-hidden"
    >
      {/* Background Effects */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg text-primary-foreground/75 mb-10 max-w-2xl mx-auto leading-relaxed">
            ...
            <strong className="text-primary-foreground">Casa do Viana</strong> é
            a única revendedora autorizada Nauber na Zona Oeste do RJ.
          </p>
